...
- [x] Clicar em "Criar Conta"
- [x] **Teste 1.1:** Tentar cadastrar sem preencher campos
  - Resultado esperado: Mensagem de erro "Preencha todos os campos"
- [x] **Teste 1.2:** Cadastrar com email inválido
  - Email: `teste@invalido`
  - Resultado esperado: Erro de formato de email
- [x] **Teste 1.3:** Cadastrar com senha curta (menos de 6 caracteres)
  - Senha: `123`
  - Resultado esperado: Erro "Senha deve ter no mínimo 6 caracteres"
- [x] **Teste 1.4:** Cadastrar com senhas diferentes
  - Senha: `123456`
  - Confirmar: `654321`
  - Resultado esperado: Erro "As senhas não coincidem"
- [x] **Teste 1.5:** Cadastro válido
  - Nome: `Teste Usuário`
...
- [x] Fazer logout
- [x] **Teste 1.6:** Login com email inexistente
  - Email: `naoexiste@exemplo.com`
  - Senha: `123456`
  - Resultado esperado: Erro "Usuário não encontrado"
- [x] **Teste 1.7:** Login com senha incorreta
  - Email: `teste@exemplo.com`
  - Senha: `senhaerrada`
  - Resultado esperado: Erro "Senha incorreta"
- [x] **Teste 1.8:** Login válido
  - Email: `teste@exemplo.com`
  - Senha: `123456`
...
- [x] **Teste 1.9:** Clicar em "Esqueceu a senha?"
- [x] Inserir email válido: `teste@exemplo.com`
- [x] Resultado esperado: Email de recuperação enviado
- [x] Verificar recebimento do email
- [x] Seguir link de recuperação
...
- [x] **Teste 2.1:** Ir para Transações → "+" → Receita
- [x] Preencher formulário:
  ...
  - Categoria: `Salário`
- [x] Clicar em "Salvar"
- [x] Resultado esperado: Receita criada, aparece no histórico
- [x] Verificar se saldo foi atualizado na Home

### Listar Receitas

- [x] **Teste 2.2:** Ir para Histórico
- [x] Verificar se a receita criada aparece
- [x] Verificar se valor está correto (R$ 5.000,00)
- [x] Verificar se data está correta
- [x] Verificar cor verde para receita

### Editar Receita

- [x] **Teste 2.3:** Clicar na receita criada
- [x] Clicar em "Editar"
- [x] Alterar valor para: `5500`
- [x] Clicar em "Salvar"
- [x] Resultado esperado: Receita atualizada
- [x] Verificar se saldo foi recalculado

### Excluir Receita

- [x] **Teste 2.4:** Clicar na receita
- [x] Clicar em "Excluir"
- [x] Confirmar exclusão
- [x] Resultado esperado: Receita removida do histórico
- [x] Verificar se saldo foi recalculado

### Receita Recorrente

- [x] **Teste 2.5:** Criar receita marcando "Recorrente"
- [x] Definir frequência: Mensal
- [x] Resultado esperado: Sistema deve criar automaticamente nos próximos meses
...
- [x] **Teste 3.1:** Ir para Transações → "+" → Despesa
- [x] Preencher formulário:
  - Descrição: `Aluguel`
  - Valor: `1500`
  - Data: Data atual
  - Categoria: `Moradia`
- [x] Clicar em "Salvar"
- [x] Resultado esperado: Despesa criada
- [x] Verificar se saldo diminuiu na Home

### Validações

- [x] **Teste 3.2:** Tentar criar despesa sem descrição
  - Resultado esperado: Erro
- [x] **Teste 3.3:** Tentar criar despesa com valor zero
  - Resultado esperado: Erro
- [x] **Teste 3.4:** Criar despesa com valor muito alto (ex: 999999999)
  - Resultado esperado: Aceito (ou limite se implementado)

### Listar e Filtrar

- [x] **Teste 3.5:** Ir para Histórico
- [x] Filtrar por tipo: "Despesas"
- [x] Resultado esperado: Mostrar apenas despesas
- [x] Verificar cor vermelha

      ...
      [
        { text: t("goals.actions.cancel"), style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              Alert.alert(
                t("goals.actions.deleteSuccessTitle"),
                t("goals.actions.deleteSuccess"),
              );
            }
          },
        },
    ...
    <View style={styles.container}>
                ...
                >
                  <View style={styles.goalHeader}>
                    ...
                    <View style={styles.goalInfo}>
                      <Text style={styles.goalTitle}>{goal.title}</Text>
                      <Text
                        style={[styles.goalDeadline, { color: colors.success }]}
                      >
      ...
      <View style={styles.footer}>
        <Button
          ...
          leftIcon={
            <Feather name="target" size={20} color={colors.onPrimary} />
          }
        />
      </View>
    </View>

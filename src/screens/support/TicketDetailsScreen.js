...
const TicketDetailsScreen = ({ route, navigation }) => {
  ...
  const { tickets, addMessage, rateTicket, closeTicket, subscribeToTicket } =
    useSupportStore();
  ...
  const handleSendMessage = async () => {
    ...
    if (result.success) {
      ...
      Alert.alert(
        t("ticketDetailsScreen.errors.notFoundTitle"),
        t("ticketDetailsScreen.errors.sendMessage"),
      );
    }
  };
  ...
  const handleSubmitRating = async () => {
    if (rating === 0) {
      Alert.alert(
        t("ticketDetailsScreen.rating.alertTitle"),
        t("ticketDetailsScreen.rating.alertMessage"),
      );
      return;
    }
        ...
        {showRating && (
          <View style={styles.ratingContainer}>
            <Text style={styles.ratingTitle}>
              {t("ticketDetailsScreen.rating.title")}
            </Text>
            ...
            >
              <Text style={styles.submitRatingText}>
                {t("ticketDetailsScreen.rating.submit")}
              </Text>
            </TouchableOpacity>
          </View>
        )}
        ...
        <View style={styles.inputContainer}>
          ...
          >
            <Text style={styles.sendButtonText}>
              {t("ticketDetailsScreen.actions.send")}
            </Text>
          </TouchableOpacity>
        </View>
      )}

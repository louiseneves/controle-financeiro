...
const CreateTicketScreen = ({ navigation }) => {
  ...
  const priorities = [
    {
      value: "low",
      label: t("supportCreateTicket.priorities.low"),
      color: colors.success,
    },
    {
      value: "medium",
      label: t("supportCreateTicket.priorities.medium"),
      color: colors.warning,
    },
    {
      value: "high",
      label: t("supportCreateTicket.priorities.high"),
      color: colors.error,
    },
  ];
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.subject.trim()) {
      Alert.alert(
        t("supportCreateTicket.alerts.error"),
        t("supportCreateTicket.alerts.subjectRequired"),
      );
      return;
    }
    ...
    if (!formData.description.trim()) {
      Alert.alert(
        t("supportCreateTicket.alerts.error"),
        t("supportCreateTicket.alerts.descriptionRequired"),
      );
      return;
    }
    ...
    if (formData.description.length < 20) {
      Alert.alert(
        t("supportCreateTicket.alerts.error"),
        t("supportCreateTicket.alerts.descriptionMin"),
      );
      return;
    }
    ...
    if (result.success) {
      ...
      Alert.alert(
        t("supportCreateTicket.alerts.error"),
        t("supportCreateTicket.alerts.createError"),
      );
    }
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>
          {t("supportCreateTicket.header.title")}
        </Text>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("supportCreateTicket.form.subject")}
          </Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("supportCreateTicket.form.category")}
          </Text>
          <ScrollView
            horizontal
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("supportCreateTicket.form.priority")}
          </Text>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("supportCreateTicket.form.description")}
          </Text>
          <TextInput
          ...
          <Text style={styles.charCount}>
            {t("supportCreateTicket.form.charCount", {
        ...
        <View style={styles.tipsContainer}>
          <Text style={styles.tipsTitle}>
            <MaterialCommunityIcons
              ...
              color={colors.text}
            />
            {t("supportCreateTicket.tips.title")}
          </Text>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.submitButtonText}>
              {t("supportCreateTicket.actions.submit")}
            </Text>
          )}
        </TouchableOpacity>
      </View>

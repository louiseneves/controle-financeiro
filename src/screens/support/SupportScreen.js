    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        >
          ...
          <View style={styles.optionContent}>
            <Text style={styles.optionTitle}>
              {t("supportScreen.options.faq.title")}
            </Text>
        ...
        >
          ...
          <View style={styles.optionContent}>
            <Text style={styles.optionTitle}>
              {t("supportScreen.options.ticket.title")}
            </Text>
            <Text style={styles.optionSubtitle}>
        ...
        >
          ...
          <View style={styles.optionContent}>
            <Text style={styles.optionTitle}>
              {t("supportScreen.options.tutorials.title")}
            </Text>
            <Text style={styles.optionSubtitle}>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>
            {t("supportScreen.myTickets.title")}
          </Text>
        ...
        {tickets.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              {t("supportScreen.myTickets.emptyTitle")}
            </Text>
            ...
            {openTickets.length > 0 && (
              <>
                <Text style={styles.subsectionTitle}>
                  {t("supportScreen.myTickets.open")}
                </Text>
                ...
                {openTickets.length > 3 && (
                  ...
                  >
                    <Text style={styles.viewAllText}>
                      {t("supportScreen.myTickets.viewAll")} (
                      {openTickets.length})
                    </Text>
                  </TouchableOpacity>
                )}
                  ...
                  >
                    <View style={styles.ticketHeader}>
                      ...
                      <View style={[styles.statusBadge, styles.statusresolved]}>
                        <Text style={styles.statusText}>
                          {t("supportScreen.ticketStatus.resolved")}
                        </Text>
                      </View>
                    </View>
                    <Text style={styles.ticketCategory}>
        ...
        <View style={styles.contactButtons}>
          ...
          >
            ...
            <Text style={styles.contactButtonText}>
              {" "}
              {t("supportScreen.contact.whatsapp")}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.contactButton}

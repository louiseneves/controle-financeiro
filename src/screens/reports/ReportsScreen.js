...
const ReportsScreen = ({ navigation }) => {
  ...
  const barData = [
    ...
    {
      type: "Investimentos",
      amount: convertFromBRL(investment),
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Text style={styles.historyButtonIcon}>
      ...
      >
        ...
        <Text style={[styles.historyButtonArrow, { color: colors.warning }]}>
          ›
        </Text>
      </TouchableOpacity>
      {/* Seletor de período */}
      ...
      <View style={styles.summaryCards}>
        <View
          style={[
            styles.summaryCard,
            { backgroundColor: colors.investment + "20" },
          ]}
        >
          <Text style={styles.summaryCardLabel}>
            {t("reports.summary.investment")}
          </Text>
        ...
        <View
          style={[styles.summaryCard, { backgroundColor: colors.offer + "20" }]}
        >
          <Text style={styles.summaryCardLabel}>
            {t("reports.summary.offer")}
          </Text>
      ...
      {categoryData.length > 0 && (
        <View style={styles.categoryList}>
          <Text style={styles.sectionTitle}>
            {t("reports.charts.allCategories")}
          </Text>
      ...
      {periodTransactions.length === 0 && (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtext}>{t("reports.empty.hint")}</Text>
        </View>
      )}
    </ScrollView>
  );

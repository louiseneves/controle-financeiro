export const translations = {
  ...
  'pt-BR': {
    ...
    advancedReports: {
      ...
      projection: {
        ...
        info:
          'Projeção baseada na média dos últimos 3 meses. Mantenha seus registros atualizados para previsões mais precisas.',
      },
      ...
      export: {
        ...
        alerts: {
          ...
          pdfMessage: 'Funcionalidade de exportação em PDF (em desenvolvimento)',
    ...
    premium: {
      ...
      alerts: {
        ...
        cancelMessage: 'Tem certeza que deseja cancelar sua assinatura Premium? Você perderá acesso aos recursos premium.',
        demoDisclaimer:
          '* Modo de demonstração. Em produção, a cobrança será feita via Google Play.',
        ok: 'OK',
        limitTitle: 'Limite alcançado',
        goalsLimit: 'Usuários gratuitos podem criar até {{limit}} metas. Faça upgrade para desbloquear metas ilimitadas.',
        budgetLimit: 'Apenas um orçamento ativo por vez está disponível sem assinatura Premium.',
        supportLimit: 'Você atingiu o número máximo de tickets abertos (3). Faça upgrade para entrar em contato novamente.',
      },
    },
    profile: {
      title: 'Perfil',
  ...
  contact: {
    ...
    description: 'Nossa equipe está disponível de segunda a sexta, das 9h às 18h.',
    whatsapp: 'WhatsApp',
    email: 'Email',
    errorTitle: 'Erro',
...
tutorialsScreen: {
  ...
  footer: {
    ...
    text:
      'Visite nossa Central de Ajuda (FAQ) ou envie um ticket de suporte. Estamos aqui para ajudar!',
  },
...
addOffer: {
  ...
  tithe: {
    ...
    emptyState: 'Adicione suas receitas do mês para calcular o dízimo automaticamente',
  ...
  categories: {
    income: {
      salary: 'Salário',
      freelance: 'Freelance',
      investments: 'Rendimento de Investimentos',
      bonus: 'Bônus',
      gift: 'Presente',
      sale: 'Venda',
      rent: 'Aluguel',
  ...
  'en-US': {
    ...
    budgetOverview: {
      ...
      warnings: {
        ...
        overLimit:
          'You exceeded the budget for this category by {{amount}}!',
      },
    ...
    advancedReports: {
      ...
      projection: {
        ...
        info:
          'Projection based on the average of the last 3 months. Keep your records updated for more accurate forecasts.',
      },
    ...
    backup: {
      ...
      alerts: {
        ...
        premiumMessage:
          'Data export is available only for Premium users.',
        upgrade: 'Upgrade',
      },
    ...
    premium: {
      ...
      alerts: {
        ...
        cancelMessage: 'Are you sure you want to cancel your Premium subscription? You will lose access to premium features.',
        demoDisclaimer:
...
tutorialsScreen: {
  ...
  footer: {
    ...
    text:
      'Visit our Help Center (FAQ) or submit a support ticket. We are here to help!',
  },
...
investmentsList: {
  ...
  transactionsNavigator: {
    ...
    emptyState: 'Add your monthly income to automatically calculate the tithe',
    ...
    items: [
      {
        ...
        answer: 'To create an income, go to the home screen and tap the "+" button or "New Income". Fill in the amount, category, date, and description. Then just save!',
        popular: true,
      },
      {
        id: '2',
        ...
        answer: 'On the home screen, tap the "+" button or "New Expense". Choose a category, enter the amount, date, and description. You can also mark it as a recurring expense if it repeats every month.',
        popular: true,
      },
      {
        id: '3',
        ...
        answer: 'The tithe is calculated automatically as 10% of your income. You can access the Tithe Calculator in the menu to see how much you should give based on your monthly income.',
        popular: true,
      },
      {
        id: '4',
        ...
        answer: 'Yes! Besides tithe, you can register offerings for missions, construction, humanitarian aid, and other causes. Just go to "Offerings" and record each donation separately.',
        popular: false,
      },
      {
        id: '5',
        ...
        answer: 'Go to "Investments" in the menu and click "New Investment". Choose the type (savings, stocks, CDB, etc.), invested amount, date, and expected return. The app will calculate your earnings.',
        popular: false,
      },
      {
        id: '6',
        ...
        answer: 'Go to "Goals" in the menu and tap "New Goal". Set the name (e.g., New Car), target amount, deadline, and how much you already have saved. The app will show your progress.',
        popular: true,
      },
      {
        id: '7',
        ...
        answer: 'In "Planning", you set how much you want to spend per category each month. The app tracks your spending and alerts you when you\'re close to the limit. This helps you control your spending better!',
        popular: false,
      },
      {
        id: '8',
        ...
        answer: 'Premium offers: advanced reports, PDF/Excel export, period comparisons, future projections, trend analysis, automatic backup, and priority support.',
        popular: true,
      },
      {
        id: '9',
        ...
        answer: 'Yes! Your data is stored encrypted on Firebase. You can do manual or automatic backups and restore on any device. Only you can access your data.',
        popular: false,
      },
      {
        id: '10',
        ...
        answer: 'Go to "Profile" > "Settings" > "Change Password". Enter your current password and the new password twice. You can also use "Forgot password" on the login screen to reset it.',
        popular: false,
      },
      {
        id: '11',
        ...
        answer: 'Yes! Log in with the same account on any device. Use the "Sync Devices" function in Backup to ensure all data is up to date.',
        popular: false,
      },
      {
        id: '12',
        ...
        answer: 'In the transaction history, swipe the transaction to the side or tap it and choose "Delete". You can also edit the data if you made a mistake.',
        popular: false,
      },
    ],
  },
...
'es-ES': {
      ...
      title: 'Proyección del Próximo Mes',
        income: 'Ingresos Previstos',
          expense: 'Gastos Previstos',
            balance: 'Saldo Previsto',
              info:
      'Proyección basada en el promedio de los últimos 3 meses. Mantén tus registros actualizados para mayor precisión.',
        },
      ...
      title: 'Exportar Informe',
        ...
        pdfTitle: 'Exportar PDF',
          pdfMessage: 'Función de exportación en PDF (en desarrollo)',
            excelTitle: 'Exportar Excel',
              excelMessage:
        'Función de exportación en Excel (en desarrollo)',
          },
    },
  },
  history: {
          ...
          errorTitle: 'Error',
            errorMessage: 'No se pudo actualizar el perfil',
              ...
              discardTitle: '¿Descartar cambios?',
                discardMessage:
      'Tienes cambios no guardados. ¿Deseas descartarlos?',
        ...
        welcomeTitle: '¡Bienvenido a Premium! 🎉',
          welcomeMessage: 'Ahora tienes acceso a todas las funciones premium.',
            cancelTitle: 'Cancelar Suscripción',
              cancelMessage: '¿Estás seguro de que deseas cancelar tu suscripción Premium? Perderás acceso a las funciones premium.',
            demoDisclaimer:
  ...
  supportCreateTicket: {
    ...
    form: {
      ...
      'Describe detalladamente tu problema o duda...',
        charCount: '{{count}} caracteres (mínimo 20)',
      },
  ...
  contact: {
    ...
    description: 'Nuestro equipo está disponible de lunes a viernes, de 9h a 18h.',
    whatsapp: 'WhatsApp',
    email: 'Correo electrónico',
    errorTitle: 'Error',
...
tutorialsScreen: {
  ...
  footer: {
    ...
    text:
      'Visita nuestro Centro de Ayuda (FAQ) o envía un ticket de soporte. ¡Estamos aquí para ayudarte!',
  },
...
investmentsList: {
  ...
  transactionsNavigator: {
    ...
    emptyState: 'Agrega tus ingresos del mes para calcular automáticamente el diezmo',
    ...
    deleteConfirm: '?Est\u00e1s seguro de que deseas eliminar esta transacci\u00f3n? Esta acci\u00f3n no se puede deshacer.',
    descriptionLabel: 'Descripci\u00f3n',
    amountLabel: 'Monto',
    dateLabel: 'Fecha',
    categoryLabel: 'Categor\u00eda',
    recurringLabel: 'Transacci\u00f3n recurrente',
    recurringDescription: 'Marca si esta transacci\u00f3n se repite mensualmente',
    ...
    items: [
      {
        ...
        answer: 'Para crear un ingreso, ve a la pantalla principal y toca el botón "+" o "Nuevo Ingreso". Completa el monto, categoría, fecha y descripción. ¡Luego solo guarda!',
        popular: true,
      },
      {
        id: '2',
        ...
        answer: 'En la pantalla principal, toca el botón "+" o "Nuevo Gasto". Elige una categoría, ingresa el monto, fecha y descripción. También puedes marcarlo como gasto recurrente si se repite cada mes.',
        popular: true,
      },
      {
        id: '3',
        ...
        answer: 'El diezmo se calcula automáticamente como el 10% de tus ingresos. Puedes acceder a la Calculadora de Diezmos en el menú para ver cuánto debes dar según tus ingresos mensuales.',
        popular: true,
      },
      {
        id: '4',
        ...
        answer: '¡Sí! Además del diezmo, puedes registrar ofrendas para misiones, construcción, ayuda humanitaria y otras causas. Solo ve a "Ofrendas" y registra cada donación por separado.',
        popular: false,
      },
      {
        id: '5',
        ...
        answer: 'Ve a "Inversiones" en el menú y haz clic en "Nueva Inversión". Elige el tipo (ahorros, acciones, CDB, etc.), monto invertido, fecha y retorno esperado. La aplicación calculará tus ganancias.',
        popular: false,
      },
      {
        id: '6',
        ...
        answer: 'Ve a "Metas" en el menú y toca "Nueva Meta". Establece el nombre (ej: Auto Nuevo), monto objetivo, fecha límite y cuánto ya has ahorrado. La aplicación mostrará tu progreso.',
        popular: true,
      },
      {
        id: '7',
        ...
        answer: 'En "Planificación", estableces cuánto deseas gastar por categoría cada mes. La aplicación rastrea tus gastos y te alerta cuando te acercas al límite. ¡Esto te ayuda a controlar mejor tus gastos!',
        popular: false,
      },
      {
        id: '8',
        ...
        answer: 'Premium ofrece: reportes avanzados, exportación en PDF/Excel, comparativas entre períodos, proyecciones futuras, análisis de tendencias, copia de seguridad automática y soporte prioritario.',
        popular: true,
      },
      {
        id: '9',
        ...
        answer: '¡Sí! Tus datos se almacenan encriptados en Firebase. Puedes hacer copias de seguridad manuales o automáticas y restaurar en cualquier dispositivo. Solo tú puedes acceder a tus datos.',
        popular: false,
      },
      {
        id: '10',
        ...
        answer: 'Ve a "Perfil" > "Configuración" > "Cambiar Contraseña". Ingresa tu contraseña actual y la nueva contraseña dos veces. También puedes usar "Olvidé mi contraseña" en la pantalla de inicio para restablecerla.',
        popular: false,
      },
      {
        id: '11',
        ...
        answer: '¡Sí! Inicia sesión con la misma cuenta en cualquier dispositivo. Usa la función "Sincronizar Dispositivos" en Copia de Seguridad para asegurar que todos los datos estén actualizados.',
        popular: false,
      },
      {
        id: '12',
        ...
        answer: 'En el historial de transacciones, desliza la transacción hacia un lado o tócala y elige "Eliminar". También puedes editar los datos si cometiste un error.',
        popular: false,
      },
    ],
  },

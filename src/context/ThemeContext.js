  ...
  const theme = {
    ...
    colors: isDark
      ? {
          ...
          // Cores de transação
          income: "#22C55E",
          // vermelho que combina com o azul primário (mesma família cromática)
          expense: "#ff6161", // harmoniza com #2563EB
          investment: "#8B5CF6",
          offer: "#F59E0B",
          tithe: "#6366F1",
      ...
      : {
          ...
          // Cores de transação
          income: "#4ADE80",
          // vermelho que combina com o azul primário no modo claro também
          expense: "#E03131", // harmoniza com #2563EB
          investment: "#8B5CF6",
          offer: "#F59E0B",
          tithe: "#6366F1",
